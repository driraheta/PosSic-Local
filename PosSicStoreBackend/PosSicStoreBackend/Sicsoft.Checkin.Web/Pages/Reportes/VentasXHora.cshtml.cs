...
{
    public class VentasXHoraModel : PageModel
    {
        private readonly ICrudApi<VentasXHoraViewModel, int> service;
        ...
        [BindProperty]
        public VentasXHoraViewModel[] EncVtas { get; set; }
        [BindProperty]
        ...
        public VentasXHoraModel(ICrudApi<CajasViewModel, string> cajas, ICrudApi<ClientesViewModel, string> clientes, ICrudApi<CajerosViewModel, string> cajeros, ICrudApi<VentasXHoraViewModel, int> service, ICrudApi<ProductosViewModel, string> productos, ICrudApi<VendedorViewModel, string> vendedor)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            try
            {
                ...
                {
                    EncVtas = await service.ObtenerListaVentasXHora(filtro);
                }
                else
                {
                    EncVtas = new VentasXHoraViewModel[0];
                }
